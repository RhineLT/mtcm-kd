...
class BraTS_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ## note, BraTS 2018 and 2019 datasets files are not ziped, so we don't need to unzip them, remove the .gz extension
        for nii in [f'{self.dataset_dir}/{img_id}/{img_id}_{s_type}.nii' for s_type in ["flair", "t1ce", "t2", "t1", "seg"]]:
